    ...
    <div className="container min-h-screen mx-auto px-10 lg:px-32 flex gap-6">
      ...
      <div className="content w-[50%] my-auto">
        <div className="flex gap-3">
          {tags.map((tag) => {
            return (
              <div className="badge badge-outline text-[#303459]">{tag}</div>
            );
          })}
        </div>
        ...
        <div className="desc mt-10">
          ...
          <p className="text-[#A3A2A8]">
            Smooth 'AIRism' fabric with the look of cotton. Narrow crew neck for
            a sleek look. Dropped shoulders and roomy half-length sleeves. The
            fabric creates a flattering silhouette.
          </p>
        </div>
